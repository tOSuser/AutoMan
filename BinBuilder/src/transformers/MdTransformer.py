...
# Description :
# --------------------------------------
# Markdown file transformer for BinBuilder.
#
#
...
class MdTransformer(TransformerBase):
	"""
	Markdown/md Transformer BinBuilder.
		-
		-
	"""
	addonid = ['transformer', 'MdTransformer',
		[['.md',[],[],'markdown file copier'],
		['.markdown',[],[],'markdown file copier']]
		]
