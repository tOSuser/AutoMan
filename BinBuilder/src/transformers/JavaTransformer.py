...
# Description :
# --------------------------------------
# Java file transformer for BinBuilder.
#
#
...
class JavaTransformer(TransformerBase):
	"""
	Java Transformer BinBuilder.
		-
		-
	"""
	addonid = ['transformer', 'JavaTransformer',
		[['.java',[],[],'Java file copier']]
		]
