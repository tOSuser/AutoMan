...
# Description :
# --------------------------------------
# Web files (html, css, ico, png, svg) transformer for BinBuilder.
#
#
...
class WebTransformer(TransformerBase):
	"""
	Web Transformer BinBuilder.
		-
		-
	"""
	addonid = ['transformer', 'WebTransformer',
		[['.html',[],[],'html file copier'],
		['.css',[],[],'css file copier'],
		['.scss',[],[],'scss file copier'],
		['.ico',[],[],'ico file copier'],
		['.png',[],[],'png file copier'],
		['.svg',[],[],'svg file copier']]
		]
